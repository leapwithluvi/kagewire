...
- Summer Sky Blue (`#3fa9e5`) + Meadow Forest Green (`#4a9c68`) as soft, high-harmony accents
...
### Primary Accents (Nature Hazards)
- **Summer Sky Blue** (`#3fa9e5` / CSS: `--color-brand-primary`): The primary action and CTA color. Represents endless summer skies, dreams, and magical paths.
- **Meadow Forest Green** (`#4a9c68` / CSS: `--color-brand-secondary`): The organic secondary accent. Used for timeline leaf nodes, highlighted markers, and success states.
...
- Background: `#3fa9e5` (Summer Sky Blue)
- Text: `#ffffff` (White), bold, rounded font
- Border radius: `rounded-full` (fully rounded pill shape)
- Hover: inverts or transitions smoothly to `#4a9c68` (Meadow Forest Green) to represent leaf growth
...
- Hover: shifts to `#3fa9e5` (Sky Blue) fill with white text
