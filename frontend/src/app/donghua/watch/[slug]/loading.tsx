...
export default function DonghuaWatchLoading() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 animate-pulse">
      <div className="h-4 w-44 rounded bg-surface-secondary/70 mb-4" />
      <div className="mb-6 border-b border-border-subtle pb-4">
        <div className="h-3 w-48 rounded bg-surface-secondary/50 mb-2" />
